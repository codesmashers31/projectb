...
export default function PricingRules() {
    ...
    const handleSinglePriceSave = async (categoryId: string, level: string, value: string) => {
        const parsed = parseInt(value, 10) || 0;
                                                        ...
                                                        <td key={level} className="py-4 px-3 text-center">
                                                            <div className="relative inline-block w-28">
                                                                ...
                                                                <input
                                                                    ...
                                                                    onBlur={(e) => handleSinglePriceSave(cat._id, level, e.target.value)}
                                                                    onKeyDown={(e) => {
                                                                        if (e.key === 'Enter') {
                                                                            (e.target as HTMLInputElement).blur();
                                                                        }
                                                                    }}
                                                                    className={`w-full pl-6 pr-2 py-1.5 text-center text-xs font-bold border rounded-lg focus:outline-none transition-colors ${
                                                                        isChanged 
